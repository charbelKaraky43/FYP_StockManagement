...
<body>
	...
	<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
		...
		<div class="inputGroup inputGroup1">
			<label for="loginEmail" id="loginEmailLabel">Username/Email</label>
			<input type="text" id="loginEmail" name="username_OR_email" maxlength="254" />
			<p class="helper helper1">Username/Email</p>
		</div>
